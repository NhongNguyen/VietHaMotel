            ...
            <div class="navbar-nav ms-auto">
                ...
                <a class="nav-link text-dark" href="{{ url('about-us') }}">Về chúng tôi</a>                
                    ...
                    <div class="d-flex align-items-center">
                        @if(session('khachthuelogin')->profile_picture)
                            <img src="{{ asset(session('khachthuelogin')->profile_picture) }}" alt="Avatar" style="width:40px; height:40px; border-radius:50%; margin-right:10px;">
                        @endif

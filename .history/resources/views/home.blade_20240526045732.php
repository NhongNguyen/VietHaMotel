                    ...
                    <div class="row my-4">
                        ...
                        @foreach($rooms as $phongtro)
                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3 pt-4">
                                <div class="card mb-4 home-card" data-url="{{ route('phongtro.show', $phongtro->id) }}">
                                    <div class="card-body position-relative">
                                        ...
                                        <div class="fixed-height-container home-card-img">
                                            <a href="#" data-lightbox="rgallery{{$phongtro->id}}" class="lightbox-trigger">
...
<script>
    ...
    document.getElementById('con-phong').addEventListener('click', function() {
        fetch('/con-phong')
            ...
            .then(data => {
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3 pt-4">
                            <div class="card mb-4 home-card">
                                ...
                                <div class="card-footer text-center">
                                    <h4>${room.tenPhong}</h4>
                                    <div class="text-success font-weight-bold">
                                        ${room.loaiphongs ? room.loaiphongs.donGia.toLocaleString('vi-VN') + ' đồng' : ''}
                                    </div>
                                    <div class="font-weight-bold text-primary">
                ...
                lightbox.reload(); // Khởi động lại lightbox để kích hoạt các liên kết mới
            });
    });
    $(document).ready(function() {
    $('.lightbox-trigger').on('click', function(e) {
        ...
        lightbox.open(galleryName, imageUrl); // Mở hình ảnh trong Lightbox

                  ...
                  <div id="user-info" style="display: none; position: absolute; top: 70px; right: 10px; background-color: white; padding: 10px; border: 1px solid #ccc;">
                    @if(session()->has('khachthuelogin') && session('khachthuelogin')->phongTro)
                        <div style="display:flex;flex-direction:column">
                            ...
                            <a type="button" class="btn-login" href="{{ url('myroom') }}">Thông tin của tôi</a>
                            <a type="button" class="btn-login" href="{{ url('changepassword') }}">Cập nhật thông tin cá nhân</a>            
                            <a type="button" class="btn-login" href="{{ url('logout') }}">Đăng xuất</a>
                        </div>
                    @endif
                  </div>
              </div>

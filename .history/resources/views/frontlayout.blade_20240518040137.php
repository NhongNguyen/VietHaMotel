                        ...
                        <div>
                            ...
                            @if(session()->has('khachthuelogin') && session('khachthuelogin')->phongTro)
                                <div style="display:flex;flex-direction:column">
                                    ...
                                    <a type="button" class="tn btn-info" style="text-align:center; border-radius:2px; padding: 10px; margin-bottom:10px;" href="{{ url('myroom') }}">Thông tin của tôi</a>
                                    <a type="button" class="tn btn-info" style="text-align:center; border-radius:2px; padding: 10px; margin-bottom:10px;" href="{{ url('changepassword') }}">Thông tin của tôi</a>            

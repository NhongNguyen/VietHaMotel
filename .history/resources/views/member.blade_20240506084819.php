        ...
        <div id="formContent">
            ...
            <div id="nomemForm">
                <form enctype="multipart/form-data" method="post" action="{{url('admin/phongtro')}}">
                    ...
                    <input name="soNamKetThuc" type="number" class="fadeIn second" required placeholder="Nhập số năm kết thúc hợp đồng"/></td>
                    <input type="hidden" name="ref" value="frontregister">
                    <input type="submit" class="fadeIn sixth" value="Đăng ký phòng">
                </form>
            </div>
            <div id="memForm" style="display: none; margin-top:-30px; transition:all ">

    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
            <div class="navbar-nav ms-auto">
                <a class="nav-link text-dark" id="text" aria-current="page" href="#services">Dịch vụ</a>
                <a class="nav-link text-dark" id="text" href="#gallery">Trưng bày</a>
                <a class="nav-link text-dark" id="text" href="{{ url('page/about-us') }}">Về chúng tôi</a>
                <a class="nav-link text-dark" id="text" href="{{ url('page/contact-us') }}">Liên hệ chúng tôi</a>
                
                    <!-- Kiểm tra nếu session 'khachthuelogin' đã được đặt -->
                    @if(session()->has('khachthuelogin'))
                    <a class="nav-link text-dark" id="text" href="{{ url('myroom') }}">Phòng trọ của tôi</a>
                    <a class="nav-link text-dark" id="text" href="{{ url('logout') }}">Đăng xuất</a>
                    @else
                        <!-- Hiển thị nút đăng nhập và đăng ký nếu chưa đăng nhập -->
                        <a class="nav-link text-dark" id="text" href="{{ url('login') }}">Đăng nhập</a>
                        <a class="nav-link text-dark" id="text" href="{{ url('register') }}">Đăng kí</a>
                    @endif
            </div>
        </div>
    </div>

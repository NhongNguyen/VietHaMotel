                            ...
                            <div class="table-responsive">
                                <form method="post" action="{{url('admin/hopdong')}}">
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <tr>
                                            <th>Giá đặt cọc</th>
                                            <td><input name="giaDatCoc" type="text" class="form-control" /></td>
                                        </tr>
                                        <tr>
                                            <th>Ngày bắt đầu</th>
                                            <td><input name="ngayBatDau" type="text" class="form-control" /></td>
                                        </tr>
                                        <tr>
                                            <th>Ngày kết thúc</th>
                                            <td><input name="ngayKetThuc" type="text" class="form-control" /></td>
                                        </tr>
                                        <tr>
                                            <td colspan="2">

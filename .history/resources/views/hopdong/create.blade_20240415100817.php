                        ...
                        <tr>
                            ...
                            <td>
                                <select name="roo_id" class="form-control roo_id">
                                    ...
                                    <option value="{{$roo->id}}" data-gia="{{$roo->loaiPhong->donGia}}">{{$roo->tenPhong}}</option>
                                    @endforeach
                                </select>
                            </td>
                        </tr>
...
<script type="text/javascript">
    $(document).ready(function() {
        $('.roo_id').on('change', function() {
            var giaDatCoc = $(this).find(':selected').data('gia');
            $('#giaDatCoc').val(giaDatCoc);
        });
    });
</script>
@endsection

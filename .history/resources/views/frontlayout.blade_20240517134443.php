...
<nav class="navbar navbar-expand-lg navbar navbar-light" style="position:fixed;top:0;width:100%;z-index:10; background-color: #E1E1E1;">
    <div class="container">
        ...
        @endif        <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNavAltMarkup" aria-controls="navbarNavAltMarkup" aria-expanded="false" aria-label="Toggle navigation">
                ...
                <a class="nav-link text-dark" href="{{ url('about-us') }}">Về chúng tôi</a>                
                    ...
                    <div class="d-flex align-items-center">
                        @if(session('khachthuelogin')->anhDaiDien)
                            <img src="{{ asset(session('khachthuelogin')->anhDaiDien) }}" alt="Avatar" style="width:40px; height:40px; border-radius:50%; margin-right:10px;">
                            <img src="{{ asset('storage/'.$d->anhDaiDien) }}" alt="Avatar" style="width:40px; height:40px; border-radius:50%; margin-right:10px;">
                        @endif
                        <div class="btn btn-danger nav-link text-white mx-2">
                            Chào {{ session('khachthuelogin')->hoKhach }} {{ session('khachthuelogin')->tenKhach }}
                        </div>
                    </div>                    <a type="button" class="btn btn-danger nav-link text-white" href="{{ url('logout') }}">Đăng xuất</a>
                    @else
    ...
    <main style="margin-top:100px; margin-bottom:30px;">
        @yield('content')
    </main>

  ...
  <nav class="navbar navbar-expand-lg navbar navbar-light" style="position:fixed;top:0;width:100%;z-index:10; background-color: #E1E1E1;">
    <div class="container">
      @if(session()->has('khachthuelogin') && session('khachthuelogin')->phongTro)
          ...
          <span class="navbar-brand text-success" style="font-size:30px">VIỆT HÀ</span>
      @else
          <!-- Render the hyperlink if the tenant does not have a room -->
          <a class="navbar-brand text-success" style="font-size:30px;font-weight:700" href="{{ url('/') }}">VIỆT HÀ</a>
      @endif        
      ...
      <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
        <div class="navbar-nav ms-auto">
          ...
          @else
            ...
            <a type="button" class="btn btn-secondary nav-link text-dark text-white" href="{{ url('register') }}">Đăng ký</a>

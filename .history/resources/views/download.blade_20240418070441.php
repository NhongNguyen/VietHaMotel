...
<body>
    <div class="container">
        ...
        <p style="text-align: center;">Hôm nay ngày {{ date('d', strtotime($hopdong->ngayBatDau)) }} tháng {{ date('m', strtotime($hopdong->ngayBatDau)) }} năm {{ date('Y', strtotime($hopdong->ngayBatDau)) }}; tại địa chỉ: 110/2 Nguyễn Đình Chiều, phường Vĩnh Phước, thành phố Nha Trang, tỉnh Khánh Hòa</p>
        <br>

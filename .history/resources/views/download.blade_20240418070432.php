...
<body>
    <div class="container">
        ...
        <p style="text-align: center;">Hôm nay ngày {{ date('d', strtotime($hopdong->ngayBatDau)) }} tháng {{ date('d', strtotime($hopdong->ngayBatDau)) }} năm ……..; tại địa chỉ: 110/2 Nguyễn Đình Chiều, phường Vĩnh Phước, thành phố Nha Trang, tỉnh Khánh Hòa</p>
        <br>

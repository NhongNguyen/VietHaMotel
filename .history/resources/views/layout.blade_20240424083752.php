...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav sidebar sidebar-dark accordion"  style=" background-image: linear-gradient(to right, #845ca5 ,#387db9)" id="accordionSidebar">
            ...
            <!-- ImageMaster -->
            <li class="nav-item">
                <a class="nav-link @if(!request()->is('admin/hinhanhphongtro*')) collapsed @endif" href="#" data-toggle="collapse" data-target="#hinhanhphongtroMaster"
                    aria-expanded="true" aria-controls="collapseTwo">
                    <i class="fas fa-house-user"></i>
                    <span>Hình ảnh phòng trọ</span>
                </a>
                <div id="hinhanhphongtroMaster" class="collapse @if(request()->is('admin/hinhanhphongtro*')) show @endif" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="{{url('admin/hinhanhphongtro/create')}}">Thêm mới</a>
                        <a class="collapse-item" href="{{url('admin/hinhanhphongtro')}}">Xem tất cả</a>
                    </div>
                </div>
            </li>

                                ...
                                <form method="post" enctype="multipart/form-data" action="{{url('admin/khachthue')}}">
                                    ...
                                    <table class="table table-bordered" >
                                        ...
                                        <tr>
                                            ...
                                            <td>
                        <input name="matKhau" type="password" class="form-control" pattern="(?=.*\d)(?=.*[a-zA-Z]).{8,}" placeholder="Mật khẩu (ít nhất 8 ký tự, chứa ít nhất một chữ cái và một số)" required />
                    </td>
                                        </tr>
                                        <tr>

            ...
            <div class="table-responsive">
                <table class="table table-bordered" >
                    ...
                    <tr>
                        ...
                        <td>
                            <img src="{{ asset('storage/app/cccdtruoc/'.$data->CCCDtruoc) }}" alt="CCCD mặt trước">
                        </td> 
                    </tr>
                    <tr>
                        <th>CCCD mặt sau</th>
                        <td>
                            <img src="{{ asset('storage/app/'.$data->CCCDsau) }}" alt="CCCD mặt sau">
                        </td>
                    </tr>
                    <tr>
                        <th>Ảnh đại diện</th>
                        <td>
                            <img src="{{ asset('storage/app/'.$data->anhDaiDien) }}" alt="Ảnh đại diện">
                        </td>
                    </tr>
                </table>
            </div>

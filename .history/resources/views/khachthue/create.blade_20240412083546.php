                                ...
                                <form method="post" enctype="multipart/form-data" action="{{url('admin/customer')}}">
                                    ...
                                    <table class="table table-bordered" >
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                            <i class="fa fa-hand-o-down" aria-hidden="true"></i>                                                <div class="custom-file border" style="text-align:center ;padding:50px;margin-bottom:10px;" onclick="document.getElementById('CCCDtruoc').click()">

...
<!-- Begin Page Content -->
                ...
                <!-- /.container-fluid -->
                <script>
    function displaySelectedImageOrName(inputId, imgId, labelId) {
...
@endsection
Trong đoạn mã trên, chúng tôi đã cập nhật hàm JavaScript displaySelectedImageOrName để hiển thị tên file ảnh hoặc hiển thị ảnh ra ngoài border tùy thuộc vào việc người dùng đã chọn ảnh hay chưa. Hàm này sẽ được gọi khi có sự kiện onchange xảy ra trên input file.

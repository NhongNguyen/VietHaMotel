                ...
                <form method="post" enctype="multipart/form-data" action="{{url('admin/khachthue/'.$data->id)}}">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tr>
                            ...
                            <td><input name="CCCDtruoc[]" value="{{$data->CCCDtruoc}}" multiple type="file" /></td>
                        </tr>
                        <tr>
                            <th>CCCD mặt sau<span class="text-danger">*</span></th>
                            <td><input name="CCCDsau[]" value="{{$data->CCCDtruoc}}" multiple type="file" /></td>
                        </tr>
                        <tr>
                            <th>Ảnh đại diện</th>
                            <td><input name="anhDaiDien[]" value="{{$data->CCCDtruoc}}" multiple type="file" /></td>
                        </tr>
                        <tr>
                            <td colspan="2">

                                ...
                                <form method="post" enctype="multipart/form-data" action="{{url('admin/khachthue')}}">
                                    ...
                                    <table class="table table-bordered" >
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                            <td>
    <input type="text" pattern="[0-9]{8,10}" minlength="8" maxlength="10" name="taiKhoan" value="{{$d->SDT}}" class="form-control" required title="Tài khoản phải là số và có từ 8 đến 10 chữ số">
</td>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <input name="matKhau" type="password" class="form-control" pattern="(?=.*\d)(?=.*[a-zA-Z]).{8,}" title="Mật khẩu phải chứa ít nhất một chữ cái và một số, và có ít nhất 8 ký tự" required />
                                            </td>
                                        </tr>
                                        <tr>

                                    ...
                                    <table class="table table-bordered" >
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align:center">
                                                ...
                                                <div class="custom-file border" style="text-align:center;height:150px;display:flex;justify:;flex-direction:column" onclick="document.getElementById('CCCDsau').click()">
                                                    <i class="fas fa-hand-point-down" style="font-size:30px"></i>

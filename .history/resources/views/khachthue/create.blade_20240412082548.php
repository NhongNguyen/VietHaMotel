                                ...
                                <form method="post" enctype="multipart/form-data" action="{{url('admin/customer')}}">
                                    ...
                                    <table class="table table-bordered" >
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="custom-file border" onclick="document.getElementById('CCCDtruoc').click()">
                                                    <input type="file" id="CCCDtruoc" name="CCCDtruoc[]" multiple  />
                                                    <label class="custom-file-label">Chọn file</label>
                                                    <span>CCCD trước</span>
                                                </div>
                                                <div class="custom-file border" onclick="document.getElementById('CCCDsau').click()">
                                                    <input type="file" id="CCCDsau" name="CCCDsau[]" multiple  />
                                                    <label class="custom-file-label">Chọn file</label>
                                                    <span>CCCD sau</span>
                                                </div>
                                            </td>

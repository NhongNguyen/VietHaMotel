                                ...
                                <form method="post" enctype="multipart/form-data" action="{{url('admin/customer')}}">
                                    ...
                                    <table class="table table-bordered" >
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="custom-file border mb-3" style="text-align:center ;padding:20px" onclick="document.getElementById('CCCDtruoc').click()">
                                                    <input style="padding:20px" type="file" id="CCCDtruoc" name="CCCDtruoc[]" multiple style="display: none" />
                                                    <label>Chọn file</label>
                                                    <span>CCCD trước</span>
                                                </div>
                                                <div class="custom-file border" style="text-align:center" onclick="document.getElementById('CCCDsau').click()">
                                                    <input style="padding:20px" type="file" id="CCCDsau" name="CCCDsau[]" multiple style="display: none" />
                                                    <label>Chọn file</label>
                                                    <span>CCCD sau</span>
                                                </div>
                                            </td>

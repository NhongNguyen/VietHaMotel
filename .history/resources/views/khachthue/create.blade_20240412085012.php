                                ...
                                <form method="post" enctype="multipart/form-data" action="{{url('admin/customer')}}">
                                    ...
                                    <table class="table table-bordered" >
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align:center">  <div class="custom-file border" style="text-align:center;height:150px;display:flex;justify-content:center;flex-direction:column" onclick="document.getElementById('CCCDsau').click()">

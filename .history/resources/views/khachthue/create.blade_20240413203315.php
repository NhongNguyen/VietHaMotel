                                ...
                                <form method="post" enctype="multipart/form-data" action="{{url('admin/khachthue')}}">
                                    ...
                                    <table class="table table-bordered" >
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" pattern="[0-9]{8,10}" minlength="8" maxlength="10" name="SDT" class="form-control" required placeholder="" title="Tài khoản phải là số và có từ 8 đến 10 chữ số">
                                            </td>
                                        </tr>
                                        <tr>

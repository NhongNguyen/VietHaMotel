                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3 pt-4">
                            <div class="card mb-4 home-card">
                                <div class="card-body position-relative">
                                    ...
                                    <div class="fixed-height-container">
                                        <a href="{{ asset('storage/${room.hinhAnhDaiDien}') }}" data-lightbox="rgallery${room.id}">
                                            <img class="img-fluid rounded w-100" src="{{ asset('storage/${room.hinhAnhDaiDien}') }}" alt="${room.tenPhong}" />
                                        </a>
                                    </div>
                                </div>
                                <div class="card-footer text-center">

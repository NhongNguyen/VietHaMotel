  ...
  <div id="formContent">
    ...
    <div style="padding-top:10px; color:black;padding-bottom:10px;"><h2>Chọn thành viên</h2> </div>
      <div class="form-check form-check-inline">
        <input class="form-check-input" type="radio" name="nomem" id="inlineRadio1" value="option1">
        <label class="form-check-label" for="inlineRadio1">Không thành viên</label>
      </div>
      <div class="form-check form-check-inline">
        <input class="form-check-input" type="radio" name="mem" id="inlineRadio2" value="option2">

...
<div class="container my-4">
    <div class="pb-3 d-flex justify-content-between align-items-center" style="border-bottom: 4px solid #E6E6E6;">
        <h1 class="h2">Danh sách trọ<span class="h6 ml-2">{{ $countPhongTros }} phòng</span></h1>
        <div>
            <button class="btn btn-success rounded-pill font-weight-bold">Còn phòng</button>
        </div>
    </div>
    <div class="row my-4">
            ...
            <div class="card mb-4">
                <div class="card-body position-relative">
                    ...
                    <a href="{{ asset('storage/'.$phongtro->hinhAnhDaiDien) }}" data-lightbox="rgallery{{$phongtro->id}}">
                        <img class="img-fluid rounded" src="{{ asset('storage/'.$phongtro->hinhAnhDaiDien) }}" alt="{{$phongtro->tenPhong}}" />
                    </a>
                </div>

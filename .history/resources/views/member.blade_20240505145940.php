    ...
    <div class="wrapper fadeInDown">
        <div id="formContent">
            ...
            <form action="{{ route('chon_thanh_vien') }}" method="POST">
                ...
                <!-- Sửa đổi input số năm kết thúc hợp đồng -->
                <input type="number" required id="namKetThuc" class="fadeIn second form-control-lg" name="namKetThuc" placeholder="Số năm kết thúc hợp đồng">
                <input type="submit" class="fadeIn fourth mt-4 text-xl" value="Chấp nhận">
            </form>
        </div>
    </div>
</div>

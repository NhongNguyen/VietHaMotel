                            ...
                            <div class="table-responsive">
                                <form enctype="multipart/form-data" method="post" action="{{url('admin/quantrivien/'.$data->id)}}">
                                    ...
                                    <table class="table table-bordered" >
                                        ...
                                        <tr>
                                            <th>Mật khẩu</th>
                                            <td><input value="{{$data->matKhau}}" name="matKhau" type="text" class="form-control" pattern="(?=.*\d)(?=.*[a-zA-Z]).{8,}" placeholder="Mật khẩu (ít nhất 8 ký tự, chứa ít nhất một chữ cái và một số)" title="Mật khẩu phải chứa ít nhất một chữ cái và một số, và có ít nhất 8 ký tự" required  /></td>
                                        </tr>
                                        <tr>
                                            <td colspan="2">

                ...
                <form method="post" enctype="multipart/form-data" action="{{ url('admin/khachthue/'.$data->id) }}">
                    ...
                    <table class="table table-bordered">
                        @if(request()->ref != 'changepassword')
                            ...
                            <tr>
                                <td><input value="{{ $data->tenKhach }}" readonly name="tenKhach" type="hidden" class="form-control" /></td>
                            </tr>
                            <tr>
                                <td><input value="{{ $data->ngaySinh }}" readonly name="ngaySinh" type="hidden" class="form-control" /></td>
                            </tr>
                            <tr>
                                <td><input value="{{ $data->queQuan }}" readonly name="queQuan" type="hidden" class="form-control" /></td>
                            </tr>
                            <tr>
                                <td><input value="{{ $data->noiThuongTru }}" readonly name="noiThuongTru" type="hidden" class="form-control" /></td>
                            </tr>
                            <tr>
                                <td><input value="{{ $data->soCCCD }}" readonly name="soCCCD" type="hidden" class="form-control" /></td>
                            </tr>
                            <tr>
                                <td><input value="{{ $data->ngayCap }}" readonly name="ngayCap" type="hidden" class="form-control" /></td>
                            </tr>
                            <tr>
                                <td><input value="{{ $data->noiCap }}"  readonly name="noiCap" type="hidden" class="form-control" /></td>
                            </tr>
                            <tr>
                                <td>
                                    <select style="display:none;" name="gioiTinh" class="form-control">

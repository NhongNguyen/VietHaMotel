...
<body>
    <div class="container">
        ...
        <p>Nơi đăng ký HK: ……………………………………………………....................</p>
        <p>CMND số:  cấp ngày {{ date('d/m/Y', strtotime($khachthues->ngayCap)) }} tại:{{$khachthues->noiCap}}</p>
        <p>Số điện thoại:……………………………………………………………………...</p>
        <br>
        ...
        <p>Số CMND: {{$khachthues->soCCCD}} cấp ngày {{ date('d/m/Y', strtotime($khachthues->ngayCap)) }} tại: ……………………...</p>

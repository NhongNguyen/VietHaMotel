        ...
        <div class="container">
            ...
            <section class="d-flex justify-content-between pt-1 pb-1" style="font-size:12px">
                <div class="flex">
                    ...
                    <a class="text-dark px-2"  href="{{ url('services') }}">Dịch vụ</a>                
                    <a class="text-dark px-2"  href="{{ url('rules') }}">Nội quy</a>          
                    <a class="text-dark px-2"  href="{{ url('about-us') }}">Về chúng tôi</a>    
                </div>

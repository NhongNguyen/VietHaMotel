    ...
    <div>
        ...
        <div class="section">
            ...
            <div class="title">PHÒNG TRỌ</div>
                <table>
                    ...
                    <tr><td>
                        ...
                        <td>
                        {{ number_format($tienSoNgayThue, 0, ',', '.') }}₫
                        </td>
                </tr>
            </table>
            </div>
            ...
            <div>
                <table>
                    ...
                    @if($chiTietHoaDonDichVus)
                        ...
                        @endforeach
                        @endif
                        @foreach($totalAmounts as $ngayLapHoaDon => $total)
                            <tr>
                                <td colspan="3"><strong>Tổng tiền ({{$ngayLapHoaDon}})</strong></td>
                                <td colspan="1">
            ...
            <div style="display:flex">
                <div style="text-align:left" class="title">TỔNG CỘNG</div> 
                <div style="text-align:right">{{ number_format($chiTietHoaDon->thanhTien, 0, ',', '.') }}₫</div> 
            </div>

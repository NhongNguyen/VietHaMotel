...
<body>
    <div class="container">
        ...
        <p>Số CMND: …………………. cấp ngày {{ date('d/m/Y', strtotime($khachthues->ngayCap)) }} tại: ……………………...</p>
        ...
        <p>Hợp đồng có giá trị kể từ {{ date('d', strtotime($hopdong->ngayBatDau)) }} tháng {{ date('m', strtotime($hopdong->ngayBatDau)) }} năm {{ date('Y', strtotime($hopdong->ngayKetThuc)) }} đến {{ date('d', strtotime($hopdong->ngayKetThuc)) }} tháng {{ date('m', strtotime($hopdong->ngayKetThuc)) }} năm {{ date('Y', strtotime($hopdong->ngayKetThuc)) }}.</p>
        <br>

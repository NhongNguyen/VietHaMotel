...
<div class="container" style="height:700px;">
    ...
    <div class="wrapper fadeInDown" style="margin-top: -50px;">
        <div id="formContent" style=" padding:20px;">
            ...
            <div id="nomemForm">
                <form enctype="multipart/form-data" method="post" action="{{url('admin/phongtro/'.$phong_id ?? '')}}">
                    @csrf
                    @method('put')
            ...
            <form enctype="multipart/form-data" method="post" action="{{url('admin/phongtro/'.$phong_id ?? ''./edit)}}">
                    @csrf
                    @method('put')

    ...
    <div class="wrapper fadeInDown">
        <div id="formContent">
            ...
            <form method="post" action="{{url('admin/khachthue')}}" enctype="multipart/form-data">
                @csrf
            <input name="hoKhach" type="text" class="form-control"  placeholder="Họ Khách thuê"/>
            <input name="tenKhach" type="text" class="form-control" />
            <input name="ngaySinh" type="date" id="ngaySinhInput" max="{{ date('Y-m-d') }}" class="form-control" />

...
<body>
<nav class="navbar navbar-expand-lg navbar navbar-light" style="position:fixed;top:0;width:100%;z-index:10; background-color:white;">
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
            <div class="navbar-nav ms-auto">
                <a class="nav-link text-dark" aria-current="page" href="#services">Dịch vụ</a>
                <a class="nav-link text-dark" href="#gallery">Trưng bày</a>
                <a class="nav-link text-dark" href="{{ url('page/about-us') }}">Về chúng tôi</a>
                <a class="nav-link text-dark" href="{{ url('page/contact-us') }}">Liên hệ chúng tôi</a>
                
                    <!-- Kiểm tra nếu session 'khachthuelogin' đã được đặt -->
                    @if(session()->has('khachthuelogin'))
                    <a class="nav-link text-dark" href="{{ url('logout') }}">Phòng trọ của tôi</a>
                    ...
                    @else
                        ...
                        <a class="nav-link text-dark" href="{{ url('myroom') }}">Đăng kí</a>
                    @endif
            </div>
        </div>
    </div>
</nav>
    <main style="margin-top:120px; margin-bottom:120px;background-color: #E1E1E1;">
        @yield('content')
    </main>
    <footer style="background-color:#E7ECFF; bottom: 0; width: 100%;">
        <div class="container">
            ...
            <section class="d-flex justify-content-between pt-1 pb-1" style="font-size:12px">
                <div class="flex">
                    <a class="text-dark px-2"  aria-current="page" href="#services" style="text-decoration:none">Dịch vụ</a>
                    <a class="text-dark px-2" href="#gallery" style="text-decoration:none">Trưng bày</a>
                    <a class="text-dark px-2" href="{{ url('page/about-us') }}" style="text-decoration:none">Về chúng tôi</a>
                    <a class="text-dark px-2" href="{{ url('page/contact-us') }}" style="text-decoration:none">Liên hệ chúng tôi</a>
                </div>

...
<body>
    <div class="container">
        <div style="text-align: center;font-size:14px;font-weight:bold">CỘNG HÒA XÃ HỘI CHỦ NGHĨA VIỆT NAM</div>
        <h3 style="text-align: center; font-size:16px">Độc lập – Tự do – Hạnh phúc</h3>
        <br>

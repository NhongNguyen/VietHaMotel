...
<script>
    ...
    // Ensure the correct form is shown based on initial state
    window.onload = function() {
        if (document.getElementById('nomem').checked) {
            toggleForm('nomemForm', 'memForm');
        } else if (document.getElementById('mem').checked) {
            toggleForm('memForm', 'nomemForm');
        }
    };
</script>

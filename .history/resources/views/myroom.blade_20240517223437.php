...
@else
    ...
    @section('content')
        <!-- Hiển thị nội dung -->
        <div class="container">
            <h1 class="border-bottom pb-2">Thông tin phòng trọ</h1>
            @if(isset($phongTro))
                ...
                <h1 class="border-bottom pb-2">Thông tin hợp đồng</h1>
                @if(isset($hopDong))
                ...
                <h1 class="border-bottom pb-2">Chi tiết hóa đơn</h1>
    ...
    .border-bottom {
        border-bottom: 2px solid #007bff; /* Màu xanh cho border dưới */
    }
    .table {
        margin-top: 20px;
    }

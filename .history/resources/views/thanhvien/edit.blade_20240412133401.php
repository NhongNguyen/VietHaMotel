                                ...
                                <form enctype="multipart/form-data" method="post" action="{{url('admin/thanhvien/'.$data->id)}}">
                                    ...
                                    <table class="table table-bordered" >
                                        <tr>
                                            ...
                                            <td><input value="{{$data->tenThanhVien}}" name="tenThanhVien" type="text" class="form-control" /></td>
                                        </tr>
                                        <tr>
                                            <th>Họ thành viên</th>
                                            <td><input value="{{$data->tenThanhVien}}" type="text" class="form-control" /></td>
                                        </tr>
                                        <tr>
                                            <th>Tên thành viên</th>
                                            <td><input name="donGia" type="number" class="form-control" /></td>
                                        </tr>
                                        <tr>
                                            <th>CCCD mặt trước<span class="text-danger">*</span></th>
                                            <td><input   name="CCCDtruoc[]" multiple type="file"/></td>
                                        </tr>
                                        <tr>
                                            <th>CCCD mặt sau<span class="text-danger">*</span></th>
                                            <td><input name="CCCDsau[]" multiple type="file" /></td>
                                        </tr>
                                        <tr>
                                            <td colspan="2">

        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
            <div class="navbar-nav ms-auto">
                ...
                <a class="nav-link text-dark" href="{{ url('about-us') }}">Về chúng tôi</a>                
                    ...
                    <div type="button" class="btn btn-danger nav-link text-white mx-2" href="{{ url('logout') }}">Chào {{  session('khachthuelogin')->hoKhach }} {{  session('khachthuelogin')->tenKhach }} </div>
                    <a type="button" class="btn btn-danger nav-link text-white" href="{{ url('logout') }}">Đăng xuất</a>
                    @else

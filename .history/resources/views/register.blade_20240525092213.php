...
<div class="container my-4">
            ...
            <div id="formContent" class="formlogin" style="max-width: 900px; margin: auto;">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input name="ngaySinh" type="date" id="ngaySinhInput" max="{{ date('d-m-Y') }}" class="fadeIn third form-control" placeholder="Ngày sinh" required>
                    </div>
                    <div class="col-md-6 mb-3">
    ...
    <input name="ngayCap" type="text" id="ngayCapInput" class="fadeIn third form-control" placeholder="Ngày cấp (dd-mm-yyyy)" required>
</div>
                    <div class="col-md-6 mb-3">
...
<script>
    ...
    const ngayCapInput = document.getElementById("ngayCapInput");

    ngaySinhInput.addEventListener("input", formatNgaySinh);
    ngayCapInput.addEventListener("input", formatNgayCap);

    function formatNgaySinh() {

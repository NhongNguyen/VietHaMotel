...
<head>
    ...
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link href="https://fonts.googleapis.com/css2?family=Dancing+Script:wght@400..700&family=Lato:ital,wght@0,100;0,300;0,400;0,700;0,900;1,100;1,300;1,400;1,700;1,900&family=Lora:ital,wght@0,400..700;1,400..700&family=Quicksand:wght@300..700&display=swap" rel="stylesheet">
    
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link href="https://fonts.googleapis.com/css2?family=Dancing+Script:wght@400..700&family=Lato:ital,wght@0,100;0,300;0,400;0,700;0,900;1,100;1,300;1,400;1,700;1,900&family=Lora:ital,wght@0,400..700;1,400..700&family=Quicksand:wght@300..700&family=Rowdies:wght@300;400;700&display=swap" rel="stylesheet">
</head>
<body>
                  ...
                  <div id="user-info" style="display: none; position: absolute; top: 70px; right: 10px; background-color: white; padding: 10px; border: 1px solid #ccc;">
                    @if(session()->has('khachthuelogin') && session('khachthuelogin')->phongTro)
                        <div style="display:flex;flex-direction:column">
                            ...
                            <a class="navbar-navshow " href="{{ url('myroom') }}">Thông tin của tôi</a>
                            <a class="navbar-navshow mb-2" href="{{ url('changepassword') }}">Cập nhật thông tin cá nhân</a>            
                            <a class="btn-login" href="{{ url('logout') }}">Đăng xuất</a>
                        </div>
                    @endif
                  </div>
              </div>
        ...
        <div class="container">
          @if(session()->has('khachthuelogin') && session('khachthuelogin')->phongTro)
            <div class="d-flex justify-content-between pt-3 pb-3">
                <div class="navbar-logo navbar-brand text-success navbar-logo" href="{{ url('/') }}">VIỆT HÀ</div>
            </div>
            
            @else
            <div class="d-flex justify-content-between pt-3 pb-3">
                <a class="navbar-logo navbar-brand text-success navbar-logo" style="font-size:20px" href="{{ url('/') }}">VIỆT HÀ</a>

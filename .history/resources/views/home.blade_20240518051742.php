...
<style>
    ...
    .img-container {
        position: relative; /* Thêm dòng này để có thể căn chỉnh phần overlay */
        z-index: 0;
    }
    ...
    .overlay {
        ...
        width: 100%;
        height: 100%;
        background: linear-gradient(to bottom, rgba(0, 0, 0, 0.8), rgba(0, 0, 0, 0.8)); /* Sửa gradient mờ đen */
        z-index: 0; /* Đảm bảo overlay nằm trên hình ảnh */
    }
</style>
<div style="margin-bottom:-200px;">
    <div class="img-container">
        <img class="full-width-img" alt="house" src="https://source.unsplash.com/random/1024x500/?house">
        <div class="overlay"></div> <!-- Thêm một phần overlay cho gradient -->
    </div>
</div>
...
<div class="container my-4" style="z-index:100">
    ...
    <div class="pb-3 d-flex justify-content-between align-items-center" style="border-bottom: 4px solid #E6E6E6;">
        <h1 class="text-white" style="z-index">Danh sách trọ<span class="h6 mx-4">{{ $countPhongTros }} phòng</span></h1>
    </div>
    <div class="row my-4">

...
<nav class="navbar navbar-expand-lg navbar navbar-light" style="position:fixed;top:0;width:100%;z-index:10; background-color: #E1E1E1;">
                ...
                <a class="nav-link text-dark" href="{{ url('about-us') }}">Về chúng tôi</a>                
                    ...
                    @if(session()->has('khachthuelogin'))
                      @if(session('khachthuelogin')->anhDaiDien)
                          <div></div><img src="{{ asset('storage/'.session('khachthuelogin')->anhDaiDien) }}" alt="Avatar" style="width:40px; height:40px; border-radius:50%; margin-right:10px;">
                          <div>
   ...
   document.addEventListener('DOMContentLoaded', function() {
    ...
    const avatar = document.querySelector('.navbar-brand img');

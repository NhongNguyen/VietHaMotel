...
.blurred-image::before {
    ...
    left: 0;
    width: 100%;
    height: 20%; /* Height of the blurred area */
    background: linear-gradient(to bottom, rgba(255, 255, 255, 0), rgba(255, 255, 255, 1)); /* Gradient to create the blur effect */
}
}
...
<div class="image-container">
        <img class="blurred-image" alt="house" src="https://source.unsplash.com/random/?house">
    </div>
</div>

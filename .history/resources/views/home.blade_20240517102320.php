...
<div class="container my-4">
    ...
    @foreach($phongtros as $phongtro)
        <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3 pt-4">
            ...
            <div id="roomList" class="row my-4">
                <!-- Danh sách phòng sẽ được thêm vào đây -->
            </div>
            <div class="card mb-4">
                <div class="card-body position-relative">
                    ...
                    @endif
                    <a href="{{ asset('storage/'.$phongtro->hinhAnhDaiDien) }}" style="width:auto;height:200px;" data-lightbox="rgallery{{$phongtro->id}}">
                        <img class="img-fluid rounded w-100 fixed-height-img" src="{{ asset('storage/'.$phongtro->hinhAnhDaiDien) }}" alt="{{$phongtro->tenPhong}}" />
                    </a>
                </div>

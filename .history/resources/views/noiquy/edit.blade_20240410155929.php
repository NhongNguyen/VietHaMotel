                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Cập nhật {{$data->tenNoiQuy}}
                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <form enctype="multipart/form-data" method="post" action="{{url('admin/noiquy/'.$data->id)}}">
                                    @csrf
                                    @method('put')
                                    <table class="table table-bordered" >
                                        <tr>
                                            <th>Tên loại phòng</th>
                                            <td><input value="{{$data->tenNoiQuy}}" name="tenNoiQuy" type="text" class="form-control" /></td>
                                        </tr>
                                        <tr>
                                            <th>Đơn giá</th>

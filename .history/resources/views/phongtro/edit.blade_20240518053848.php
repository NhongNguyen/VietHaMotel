                ...
                <form method="post" action="{{url('admin/phongtros/'.$data->id)}}">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tr>
                            ...
                            <td><input value="{{$data->soNamKetThuc}}" min="1" max="10"  name="soNamKetThuc" type="number" class="form-control" required/></td>
                        </tr>
                        <tr>
                            <th>Ảnh đại diện</th>
                            <td>  @if($data->anhDaiDien)
                            <img src="{{ asset('storage/'.$data->anhDaiDien) }}" alt="Ảnh đại diện" width="100" />
                            @endif
                            <input name="anhDaiDien" type="file"/></td>
                        </tr>
                        <tr>
                            <td colspan="2">

                    ...
                    <table class="table table-bordered" >
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <tr class="hidden-row" style="display: none;">
                                    <td>
                                        <input type="text" name="soTruoc[]" class="form-control soTruoc" required>
                                    </td>
                                    <td>
                                        <input type="text" name="soHienTai[]" class="form-control soHienTai" required>
                                    </td>
                                </tr>
                                @endforeach
                                </table>
...
$(document).ready(function(){
    $('input[type="checkbox"]').click(function(){
        ...
        if(checkbox.prop("checked") == true){
            checkbox.closest('tr').All('.hidden-row').first().show();
        }
        else if(checkbox.prop("checked") == false){
            checkbox.closest('tr').All('.hidden-row').hide();
        }
    });
});
</script>

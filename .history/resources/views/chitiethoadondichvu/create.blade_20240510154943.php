                ...
                <form enctype="multipart/form-data" method="post" action="{{url('admin/chitiethoadondichvu')}}">
                    ...
                    <table class="table table-bordered" >
                        <tr>
                            ...
                            <td>
                                <input type="text" class="form-control" readonly name="id_chi_tiet_hoa_don" value="{{ Session::get('id_chi_tiet_hoa_don') }}{{ Session::get(date('H:m:s d/m/Y', strtotime($d->ngayLapHoaDon)) }}">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input type="text" name="ngayLapChiTietHoaDon[]" class="form-control" value="{{ Session::get('ngay_lap_hoa_don') }}" readonly>
                            </td>
                        </tr>
                        <tr>
                            <th>Chọn dịch vụ</th>

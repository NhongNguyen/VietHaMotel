    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Thêm hình ảnh phòng trọ
                <a href="{{ route('hinhanhphongtro.index') }}" class="float-right btn btn-success btn-sm">Xem tất cả</a>
            </h6>
        </div>
        <div class="card-body">
            ...
            <div class="table-responsive">
                <form method="post" action="{{ route('hinhanhphongtro.store') }}" enctype="multipart/form-data">
                    @csrf

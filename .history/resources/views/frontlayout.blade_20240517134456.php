                ...
                <a class="nav-link text-dark" href="{{ url('about-us') }}">Về chúng tôi</a>                
                    ...
                    <div class="d-flex align-items-center">
                        @if(session('khachthuelogin')->anhDaiDien)
                            <img src="{{ asset(session(') }}" alt="Avatar" style="width:40px; height:40px; border-radius:50%; margin-right:10px;">
                            <img src="{{ asset('storage/'.se('khachthuelogin')->anhDaiDien) }}" alt="Avatar" style="width:40px; height:40px; border-radius:50%; margin-right:10px;">
                        @endif

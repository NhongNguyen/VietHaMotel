      ...
      <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
        <div class="navbar-nav ms-auto">
          ...
          @else
            ...
            <a  class="btn-login nav-link text-dark text-white" href="{{ url('register') }}">Đăng ký</a>
            <a  class="btn-login btn btn-primary nav-link text-dark text-white mx-2" href="{{ url('login') }}">Đăng nhập</a>
          @endif
        </div>
      </div>
    </div>

...
<section class="aboutus">
  <div class="container">
    <div class="aboutus-row" style="display: flex; align-items:center">
      <div class="aboutus-img">
        <img src="{{ asset('img/VietHa.jpg')}}" height="400px" alt="">
      </div>
      <div class="aboutus-content" style=" padding:30px;">
      ...
      Với sứ mệnh cung cấp dịch vụ nhà ở chất lượng và an toàn, Nhà Trọ Việt Hà cam kết đem lại trải nghiệm sống tốt nhất cho mọi khách hàng, từ việc quản lý thông tin phòng trọ đến dịch vụ hỗ trợ và tiện ích xung quanh.</p>

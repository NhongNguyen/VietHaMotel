...
<head>
    ...
    <style>
        ...
        body {
            ...
            padding: 20px;
            line-height: 1;
    font-family: 'Times-Bold', sans-serif; /* Sử dụng font chữ in đậm trong trang web */
        }
    </style>
</head>
<body>
    <div class="container">
        <div style="text-align: center;font-size:14px;">CỘNG HÒA XÃ HỘI CHỦ NGHĨA VIỆT NAM</div>

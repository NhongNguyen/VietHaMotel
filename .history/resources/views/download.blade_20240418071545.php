...
<body>
    <div class="container">
        ...
        <p>Hợp đồng có giá trị kể từ {{ date('d', strtotime($hopdong->ngayBatDau)) }} tháng {{ date('m', strtotime($hopdong->ngayBatDau)) }} năm {{ date('Y', strtotime($hopdong->ngayBatDau)) }}. đến ngày ….. tháng …. năm 20….</p>
        <br>

    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
            <div class="navbar-nav ms-auto">
                <a class="nav-link text-dark" href="{{ url('about-us') }}">Dịch vụ</a>                
                <a class="nav-link text-dark" href="{{ url('about-us') }}">Nội quy</a>          
                <a class="nav-link text-dark" href="{{ url('about-us') }}">Về chúng tôi</a>                
                    ...
                    @else
                        ...
                        <a type="button" class="btn btn-primary nav-link text-dark text-white ml-4" href="{{ url('login') }}">Đăng nhập</a>
                        <a type="button" class="btn btn-primary nav-link text-dark text-white" href="{{ url('register') }}">Đăng kí</a>
                    @endif
            </div>
        </div>
    </div>

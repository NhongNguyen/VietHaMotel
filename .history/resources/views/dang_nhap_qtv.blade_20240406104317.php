...
<input type="text" name="taikhoan" class="form-control form-control-user" @if(Cookie::has('qtvtaikhoan')) value="{{Cookie::get('adminuser')}}" @endif
                                                id="taikhoan" name="taikhoan" aria-describedby="emailHelp"
                                                placeholder="tài khoản">
                                        </div>
                                        <div class="form-group">
<input name="password" @if(Cookie::has('qtvmatkhau')) value="{{Cookie::get('adminpwd')}}" @endif  type="password" class="form-control form-control-user"
                ...
                if ($result === false) {
                    ...
                    if (mysqli_num_rows($result) > 0) {
                        while ($row = mysqli_fetch_assoc($result)) {
                            echo "<p><strong>Username:</strong> " . $row['username'] . ", <strong>matkhau:</strong> " . $row['matkhau'] . "</p>";
                        }
                    } else {
                        echo "0 results";
                    }

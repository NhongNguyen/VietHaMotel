...
Route::get('admin/chitiethoadon/{id}/pdf', [HopDongController::class, 'downloadPDF'])->name('hoadon.pdf');
Route::get('admin/chitiethoadon/{id}/view-pdf', [HopDongController::class, 'viewPDF'])->name('hoadon.view-pdf');

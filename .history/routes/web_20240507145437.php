...
Route::get('admin/hoadon/{id}/pdf', [HopDongController::class, 'downloadPDF'])->name('hopdong.pdf');
Route::get('admin/hoadon/{id}/view-pdf', [HopDongController::class, 'viewPDF'])->name('hopdong.view-pdf');

...
Route::post('admin/hoadon/auto-create-chitiet', [HoaDonController::class, 'autoCreateChiTiet'])->name('hoadon.autoCreateChiTietForAll');
...
// Define the route for creating chitiethoadondichvu
Route::get('admin/hoadon/{id}/create-chitiethoadondichvu', [ChiTietHoaDonDichVuController::class, 'create'])->name('create-chitiethoadondichvu');

...
Route::get('/phongtro/{id}', [PhongTroController::class, 'show'])->name('phongtro.show');
...
Route::put('admin/chitiethoadon/{id}/updatePaymentStatus', [ChiTietHoaDonController::class, 'updatePaymentStatus'])->name('chitiethoadon.updatePaymentStatus');

...
Route::get('admin/hoadon/{id}/create-chi-tiet-hoa-don', [HoaDonController::class, 'createChiTietHoaDon']'HoaDonController@createChiTietHoaDon')->name('createChiTietHoaDon');

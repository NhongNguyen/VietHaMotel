...
Route::post('/chon-thanh-vien', [ThanhVienController::class, 'chonThanhVien'])->name('chon_thanh_vien');
Route::get('member',[PhongTroController::class,'member']);
...
Route::get('admin/hoadon/{id}/create-chi-tiet-hoa-don', [HoaDonController::class, 'createChiTietHoaDonDichVu']'HoaDonController@createChiTietHoaDon')->name('createChiTietHoaDon');
Route::get('admin/hoadon/{id}/create-chitiethoadondichvu', [HoaDonController::class, 'createChiTietHoaDonDichVu'])->name('hoadon.create-chitiethoadondichvu');

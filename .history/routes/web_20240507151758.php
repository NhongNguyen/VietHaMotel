...
Route::get('admin/hoadon/{id}/cthdpdf', [HoaDonController::class, 'downloadCTHDPDF'])->name('hoadon.pdf');
Route::get('admin/hoadon/{id}/view-cthd-pdf', [HoaDonController::class, 'viewCTHDPDF'])->name('hoadon.view-pdf');

...
class ChiTietHoaDonController extends Controller
{
    ...
    public function viewPDF($id)
    {
     ...
     /**
     * Update the payment status of the specified resource in storage.
     *
     * @param  \Illuminate\Http\Request  $request
     * @param  int  $id
     * @return \Illuminate\Http\Response
    ...
    {
        $request->validate([
            'daThanhToan' => 'required|string|in:Chưa,Đã thanh toán',
        ]);

        $chiTietHoaDon = ChiTietHoaDons::findOrFail($id);
        $chiTietHoaDon->daThanhToan = $request->daThanhToan;
        $chiTietHoaDon->save();

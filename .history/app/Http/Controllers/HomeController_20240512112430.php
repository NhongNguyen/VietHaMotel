...
class HomeController extends Controller
{
    ...
    if($khachthue) {
        // Nếu đã đăng nhập, lấy thông tin của khách thuê
        $khachthueId = $khachthue->id;
        $khachthueName = $khachthue->tenKhach;
    }
        
        return View('myroom',['loaiphongs'=>$loaiphongs,'dichvus'=>$dichvus,'phongtros'=>$phongtros,'khachthueId' => $khachthueId,'khachthueName' => $khachthueName]);
    }
}

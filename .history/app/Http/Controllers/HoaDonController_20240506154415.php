...
class HoaDonController extends Controller
{
    ...
    public function autoCreateChiTietForAll(Request $request)
    {
     ...
     /**
     * Hiển thị hóa đơn dưới dạng PDF.
     *
     * @param  int  $id
     * @return \Illuminate\Http\Response
     */
    public function viewPDF($id)
    {
        ...
        // Tạo một view PDF sử dụng dữ liệu từ hóa đơn
        $view = View::make('pdf.hoadon', compact('hoaDon'));
        ...
        // Thiết lập kích thước giấy và hướng (portrait hoặc landscape)
    ...
    public function downloadPDF($id)
    {
        ...
        $filename = "HoaDon_" . $hoaDon->id . ".pdf";

...
public function destroy($id)
{
    ...
    foreach ($hoaDons as $hoaDon) {
        $chiTietHoaDon = ChiTietHoaDons::where('id_hoa_don', $hoaDon->id)->first();
        if ($chiTietHoaDon) {
            $chiTietHoaDonDichVu = ChiTietHoaDonDichVus::where('id_chi_tiet_hoa_don', $chiTietHoaDon->id)->first();

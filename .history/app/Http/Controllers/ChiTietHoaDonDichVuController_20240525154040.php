...
public function create()
{
    ...
    return view('chitiethoadondichvu.create', ['chitiethoadons' => $chitiethoadons, 'dichvus' => $dichvus, 'hoadons' => $hoadons, 'phongtros' => $phongtros, 'id_chi_tiet_hoa_don'=>$id_chi_tiet_hoa_don, '']);
}

...
public function destroy($id)
{
    ...
    foreach ($hoaDons as $hoaDon) {
        ...
        // Kiểm tra xem còn hợp đồng nào khác với phòng này không
        $hopdongCount = HopDongs::where('id_phong_tro', $phongTroId)->count();

        // Nếu không còn hợp đồng nào khác với phòng này, cập nhật trạng thái của phòng
        if ($hopdongCount == 0) {

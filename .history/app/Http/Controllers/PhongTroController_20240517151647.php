    ...
    public function update(Request $request, $id)
{
    ...
    if ($request->ref == 'firstregister') {
        ...
        // Lấy id của thành viên vừa tạo
        $latestMemberId = $thanhVien->id;

        // Cập nhật id_thanh_vien của phòng trọ với id của thành viên mới nhất
        $data->id_thanh_vien = $latestMemberId;
    }

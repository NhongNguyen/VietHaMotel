...
public function view($id)
{
    ...
    $chiTietHoaDonDichVus = $chiTietHoaDon->chitiethoadondichvus; // Lấy danh sách chitiethoadondichvus của id_chi_tiet_hoa_don

    return view('chitiethoadondichvu.show', compact('chiTietHoaDonDichVus'));
}

    ...
    public function myroom() {
        ...
        if (session()->has('khachthuelogin')) {
            ...
            if ($phongTro) {
                ...
                $thanhVien = ThanhViens::where('id_phong_tro', $idPhongTro)->first();
                ...
                return view('myroom', ['phongTro' => $phongTro, 'hopDong' => $hopDong, 'hoaDon' => $hoaDon, 'chiTietHoaDon' => $chiTietHoaDon,'khachThue' => $khachThue,'khachThue' => $khachThue]);
            } else {

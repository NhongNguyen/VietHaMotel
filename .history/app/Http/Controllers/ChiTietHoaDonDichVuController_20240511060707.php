...
class ChiTietHoaDonDichVuController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        ChiTietHoaDonDichVus::where('id_chi_tiet_hoa_don', $id_chi_tiet_hoa_don)
            ->where('ngayLapChiTietHoaDon', $ngayLapChiTietHoaDon)
            ->update(['thanhTien' => DB::raw("thanhTien + $totalAmount")]); // Sửa lại thành DB::raw()

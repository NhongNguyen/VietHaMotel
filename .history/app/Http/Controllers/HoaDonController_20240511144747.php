...
/**
    ...
    public function viewCTHDPDF($id)
    {
        ...
        $loaiPhong = LoaiPhongs::findOrFail($phongTro->id_
        ...
        $view = View::make('cthddownload', compact('chiTietHoaDon','hoaDon','phongTro','khachThue','tienSoNgayThue','chiTietHoaDonDichVus','totalAmounts'));
    ...
    public function createChiTietHoaDon($hoaDonId)
    {
        ...
        if ($hoaDon->hopdongs) {
            ...
            $hoaDon->save();
            Session::put('id_chi_tiet_hoa_don', $chiTietHoaDon->id);
            Session::put('ngay_lap_hoa_don', $ngayHienTai);

    ...
    public function myroom() {
        ...
        if (session()->has('khachthuelogin')) {
            ...
            if ($phongTro) {
                ...
                // Nếu có, trả về view với thông tin phòng trọ và thông tin hợp đồng
                return view('myroom', ['phongTro' => $phongTro, 'hopDong' => $hopDong]);
            } else {
                // Nếu không có thông tin phòng trọ, có thể hiển thị thông báo hoặc chuyển hướng người dùng đến trang khác
                return redirect('myroom')->with('error', 'Không tìm thấy thông tin phòng của bạn.');
            }
        } else {
            // Nếu người dùng chưa đăng nhập, chuyển hướng họ đến trang đăng nhập
            return redirect('')->with('error', 'Bạn cần đăng nhập để xem phòng của mình.');
        }
    }

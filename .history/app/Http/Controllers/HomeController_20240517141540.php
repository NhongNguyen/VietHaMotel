...
class HomeController extends Controller
{
    ...
    public function myroom() {
        ...
        if ($khachthue && $khachthue->phongTro->isNotEmpty()) {
            // Lấy thông tin về phòng trọ của khách thuê đang đăng nhập
            $phongTro = $khachthue->phongTro->first();
    
            // Trả về trang myroom với thông tin về phòng trọ
            return view('myroom', ['phongTro' => $phongTro]);
        } else {
            // Trả về trang myroom mà không có thông tin về phòng trọ nếu không có phòng trọ được thuê
            return view('myroom');
        }
    }
    // Home Page

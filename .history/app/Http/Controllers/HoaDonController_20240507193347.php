...
/**
    ...
    public function viewCTHDPDF($id)
    {
        ...
        $khachthues = KhachThues::findOrFail($hoadons->id_khach_thue);
        $phongtros = PhongTros::findOrFail($hoadons->id_phong_tro);
        $chiTietHoaDon = ChiTietHoaDons::findOrFail($id);
      


        // Tạo một view PDF sử dụng dữ liệu từ chi tiết hóa đơn
        $view = View::make('cthddownload', compact('chiTietHoaDon','khachthues', 'phongtros','hoadons'));

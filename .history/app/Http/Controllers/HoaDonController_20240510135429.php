...
class HoaDonController extends Controller
{
    ...
    public function autoCreateChiTiet(Request $request, $id)
    {
        ...
        if ($hoaDon->hopdongs) {
            ...
            // Chuyển hướng người dùng đến trang tạo chi tiết hóa đơn dịch vụ
            return redirect()->route('create-chitiethoadondichvu', ['id' => $hoaDon->id]);
        }
    
        // Nếu không có hợp đồng, chuyển hướng người dùng về trang danh sách hóa đơn với thông báo lỗi
        return redirect('admin/hoadon')->with('error', 'Hóa đơn không có hợp đồng.');
    }
